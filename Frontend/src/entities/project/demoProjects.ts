...
export const nodexMeshDemoProject: Project = {
  ...
  items: [
      ...
      columns: [
        {
          ...
          cards: [
            ...
            { id: 'ab0274fa-5623-4e77-ba4a-3e7534e61638', text: 'Implement MindMapBlock', done: true },
            {
              id: 'c8a8147b-cfe4-4040-bbf2-2a51f85deb33',
              text: 'Make in timeline tasks show and dissappear when moving to the left or right',
              done: true,
            },
            { id: 'a972df58-4930-443b-9cfd-6d69d54ef87c', text: 'Implement IconBlock', done: true },
            {
            ...
            { id: '4b80bc94-79a3-4226-ac13-3f94e400fab1', text: 'Implement arrows flexibility', done: true },
            { id: '519c95c5-372c-4edb-a2db-e63d6026be5a', text: 'Increase the default item width', done: true },
            {
            ...
            { id: 'a816b10c-6ca4-422c-838e-eeba3d6108e4', text: 'Add changing colors in kanban columns', done: true },
            {
            ...
            { id: 'a8a3a9ad-812e-4bd4-be43-8b181a4b4821', text: 'Add a new Divider item', done: true },
          ],
          width: 362,
        },
        {
          ...
          color: '#FFBD65',
          cards: [
            { id: 'c635a071-de2e-48e8-95f7-cbe9ce37f384', text: 'Implement zooming in mind map block', done: true },
            {
              id: '8ed7dfa9-d125-4657-abf4-d24354182427',
              text: 'Add moving around mindmap with mouse instead of just scrolls',
              done: true,
            },
            { id: 'fca946c4-2327-4b8a-856e-9f678e5c1a8b', text: 'Fix and adjust mindmap', done: true },
            {
            ...
            { id: '55f0cf9b-300b-47a0-9511-da88494af183', text: 'Implement horizontal layout for diagram', done: true },
            {
            ...
            { id: '63812cab-d9f8-400a-8587-0f1b7c5fcd79', text: 'Fix task height in checklists', done: true },
            { id: '36957d1f-36eb-4923-82e8-803b209a6343', text: 'Implement DbDiagramBlock', done: true },
            {
              id: 'a2e4a384-1d80-4247-abef-16c55c97a6c7',
              text: 'Implement manual cleaning projects trash',
              done: true,
            },
            { id: 'ae2989ed-4791-4d26-87b6-e0fbdfb55589', text: 'Update readme', done: true },
            { id: '2609c67b-d8db-4a87-8cb8-243a40c00907', text: 'Add auto-fit to checklists', done: true },
            {
              id: '115c5853-6434-4e99-a7ed-afd716439577',
              text: 'Add vertical text alignment to item alignment options',
              done: true,
            },
            { id: '2dee4133-dda8-443f-9198-059effca02be', text: 'Adjust diagramblock', done: true },
            {
            ...
            { id: 'c53df52d-f2e7-449a-ac26-def6b8412ac7', text: 'Fix data-scroll in timeline', done: true },
            { id: 'db83522a-b84e-479e-9d1f-f226ad0c783d', text: 'Implement moving columns in kanban', done: true },
            {
        ...
        },
        {
          ...
          color: '#02A0A0',
          cards: [
            { id: '2ed12db2-89e7-4e3b-b4c0-da9f81b28a52', text: 'Implement export/import projects', done: true },
            {
            ...
            { id: '0c81ae39-0d68-43fb-bdc5-d2d7c5a3c5e0', text: 'Implement mobile devices compability', done: true },
            { id: 'e5053759-ac5c-4f2d-bb85-835ca3bbeb6b', text: 'Plan database scheme', done: true },
            { id: '1dc09034-38c2-4f04-bb19-5ace1f720978', text: 'Plan backend', done: true },
            {
            ...
            { id: '81871895-0f12-48e8-a14e-11a9990ed417', text: 'Add the ability to rename a project', done: true },
            { id: 'f252a850-e457-4062-8403-ba73df5b7720', text: 'Implement drawing on canvas', done: true },
            {
            ...
            { id: 'f4396fe1-f067-418c-aed8-2868ad53c8f4', text: 'Fix document block error', done: true },
            {
    ...
    },
    {
      title: 'Future Plans',
      entries: [
        { id: '9d171f2a-238e-4901-99db-ecba6afb544e', text: 'Custom application color themes', done: true },
        {
        ...
        { id: '45f976ec-253a-42fb-bb09-668fd7b4123f', text: 'API in C# .NET 10', done: false },
        {
        ...
        { id: 'cdc40354-fc31-4781-bb18-8c67b126a164', text: 'Read-only project sharing', done: false },
      ],
    ...
    },
    {
      title: 'Done',
      entries: [
        { id: 'fedd58e9-6d22-42f9-9d95-2bb8093af3b0', text: 'Lock items to prevent accidental movement', done: true },
        {
          id: '753b6d42-72e4-4da2-aead-9595b2015277',
          text: 'Assign tags to items and highlight items when a tag is selected',
          done: true,
        },
        { id: '84508a3f-c8c0-4d34-918e-d26446eb9a1e', text: 'Labels on arrows', done: true },
        {
        ...
        { id: '360068c0-59aa-4de8-8dcc-46f6d0b0901f', text: 'Divider', done: true },
        {
        ...
        { id: '197c89bc-c61e-4b20-9c21-d0ce47f53c61', text: 'DiagramBlock', done: true },
        {
        ...
        { id: 'dbe5c4d3-8875-4f23-bb70-b3f258db7e6c', text: 'Project management', done: true },
        {
        ...
        { id: '3f94a3fc-8da4-40ac-99b2-3b77804e27f8', text: 'Drawing - drawing on canvas', done: true },
      ],
      color: '#ffffff',
      ...
      tasks: [
        {
          ...
          color: '#000000',
          checklist: [
            { id: '3acd19d9-d816-46f1-89ae-244872fe6ad5', text: 'DocumentBlock is throwing error', done: true },
            { id: '0aa7b144-df10-444d-8150-21b7378af483', text: 'Add more fonts to app', done: true },
          ],
        },
        {
        ...
        },
        {
          ...
          color: '#000000',
          checklist: [
            { id: 'bcb98ef4-eb27-4d17-8197-5115af8dfd9e', text: 'Timeline', done: true },
            { id: '7a6b63f1-b903-466b-a6bf-c430fd5ec86a', text: 'Kanban', done: true },
          ],
        },
        {
        ...
        },
        {
          ...
          color: '#000000',
          checklist: [
            { id: 'dde96d36-5d00-42ce-be0d-87b62bf6b3c4', text: 'IconBlock', done: true },
            { id: 'b117e5d0-6d65-47e2-86ae-092d01b905a6', text: 'MindmapBlock', done: true },
          ],
        },
        {
      ...
      columns: [
        {
          ...
          color: '#5a8a94',
          cards: [
            { id: '3a253268-9f57-4962-8a90-0faf40bea619', text: 'Change editing kanban columns to dialog', done: true },
            {
            ...
            { id: 'eb123a8f-e06c-4d47-8d71-fdb58bf43b33', text: 'Implement arrow flexibility', done: true },
            {
            ...
            { id: 'c716f0aa-517b-4e31-915e-383274e7355e', text: 'Edit timeline tasks in a dialog', done: true },
            {
        ...
        },
        {
          ...
          cards: [
            ...
            { id: 'd12daa14-1bd8-4a6b-ac5e-c380b5ea3b00', text: 'Fix vertical alignment in NoteBlock', done: true },
            {
    ...
    },
    {
      ...
      strokes: [
        {
          points: [
            { x: 6, y: 165.33, pressure: 1 },
            { x: 6.54, y: 165.33, pressure: 1.17 },
            { x: 7.62, y: 165.33, pressure: 1.17 },
            { x: 11.6, y: 166, pressure: 1.16 },
            { x: 22.69, y: 166.44, pressure: 1.11 },
            { x: 42.25, y: 166.68, pressure: 1.04 },
            { x: 69.12, y: 165.83, pressure: 0.98 },
            { x: 98.9, y: 163.55, pressure: 0.93 },
            { x: 130.01, y: 159.68, pressure: 0.89 },
            { x: 163.4, y: 153.19, pressure: 0.86 },
            { x: 192.18, y: 144.34, pressure: 0.85 },
            { x: 218.58, y: 134.51, pressure: 0.84 },
            { x: 249.11, y: 121.56, pressure: 0.83 },
            { x: 282.14, y: 107.45, pressure: 0.81 },
            { x: 309.54, y: 91.37, pressure: 0.81 },
            { x: 329.75, y: 77.33, pressure: 0.82 },
            { x: 350.53, y: 60.81, pressure: 0.83 },
            { x: 369.47, y: 45.34, pressure: 0.84 },
            { x: 379.45, y: 34.29, pressure: 0.9 },
            { x: 386.07, y: 25.83, pressure: 0.97 },
            { x: 391.06, y: 18.49, pressure: 1.03 },
            { x: 394.21, y: 13.55, pressure: 1.11 },
            { x: 399.02, y: 6, pressure: 1.11 },
          ],
          x: 0,
          y: 7,
          scaleX: 1,
        ...
        {
          points: [
            { x: 6, y: 19.55, pressure: 1 },
            { x: 6.54, y: 19.55, pressure: 1.17 },
            { x: 7.49, y: 18.97, pressure: 1.24 },
            { x: 8.63, y: 18.05, pressure: 1.3 },
            { x: 11.8, y: 16.84, pressure: 1.3 },
            { x: 16.41, y: 14.13, pressure: 1.27 },
            { x: 21.79, y: 11.86, pressure: 1.24 },
            { x: 26.34, y: 9.5, pressure: 1.26 },
            { x: 30.92, y: 8.07, pressure: 1.28 },
            { x: 36.29, y: 7.17, pressure: 1.27 },
            { x: 40.52, y: 6.06, pressure: 1.28 },
            { x: 42.78, y: 6, pressure: 1.37 },
            { x: 43.87, y: 7.81, pressure: 1.34 },
            { x: 43.9, y: 11.38, pressure: 1.31 },
            { x: 42.66, y: 16, pressure: 1.29 },
            { x: 41.93, y: 20.65, pressure: 1.27 },
            { x: 41.53, y: 24.32, pressure: 1.3 },
            { x: 40.71, y: 28.3, pressure: 1.32 },
            { x: 40.22, y: 31.24, pressure: 1.36 },
            { x: 39.39, y: 33, pressure: 1.43 },
            { x: 37.87, y: 36.24, pressure: 1.43 },
          ],
          x: 367,
          y: 0,
          scaleX: 1,
    ...
    },
    {
      content: 'Custom SVG',
      size: 'lg',
      typography: { verticalAlign: 'middle', textAlign: 'center' },
