...
export default function CanvasHints({ selectedTool, hasSelection }: CanvasHintsProps) {
  return (
    <>
      {selectedTool !== 'select' && (
        <div className="canvas-hint absolute bottom-5 left-1/2 -translate-x-1/2 pointer-events-none hint-pulse">
          <div
      ...
      {selectedTool === 'select' && !hasSelection && (
        <div className="canvas-hint canvas-desktop-hint absolute bottom-5 left-1/2 -translate-x-1/2 pointer-events-none">
          <div
