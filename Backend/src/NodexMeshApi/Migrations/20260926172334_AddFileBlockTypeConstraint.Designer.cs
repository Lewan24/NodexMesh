...
namespace NodexMeshApi.Migrations
{
    ...
    [Migration("20260926172334_AddFileBlockTypeConstraint")]
    partial class AddFileBlockTypeConstraint
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NodexMeshApi.Auditing.AuditDetectionCheckpoint", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<DateTime>("ProcessedThrough")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("processed_through");

                    b.HasKey("Id")
                        .HasName("pk_audit_detection_checkpoints");

                    b.ToTable("audit_detection_checkpoints", (string)null);
                });

            modelBuilder.Entity("NodexMeshApi.Auditing.AuditEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("RequestId")
                        .HasDatabaseName("ix_audit_events_request_id");

                    b.HasIndex("AccountKey", "OccurredAt")
                        .HasDatabaseName("ix_audit_events_account_key_occurred_at");

                    b.HasIndex("ActorId", "OccurredAt")
                        .HasDatabaseName("ix_audit_events_actor_id_occurred_at");

                    b.HasIndex("Category", "OccurredAt")
                        .HasDatabaseName("ix_audit_events_category_occurred_at");

                    b.HasIndex("ClientIp", "OccurredAt")
                        .HasDatabaseName("ix_audit_events_client_ip_occurred_at");

                    b.HasIndex("EventType", "OccurredAt")
                        .HasDatabaseName("ix_audit_events_event_type_occurred_at");

                    b.HasIndex("ProjectId", "OccurredAt")
                        .HasDatabaseName("ix_audit_events_project_id_occurred_at");
            ...
            modelBuilder.Entity("NodexMeshApi.Auditing.SecurityIncident", b =>
                {
                    ...
                    b.HasIndex("Status", "WindowStart")
                        .HasDatabaseName("ix_security_incidents_status_window_start");

                    b.HasIndex("Rule", "Subject", "WindowStart")
                        .IsUnique()
                        .HasDatabaseName("ix_security_incidents_rule_subject_window_start");
            ...
            modelBuilder.Entity("NodexMeshApi.Models.EmailOutboxMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("LeaseId")
                        .HasDatabaseName("ix_email_outbox_lease_id");

                    b.HasIndex("SentAt", "DeadLetteredAt", "AvailableAt")
            ...
            modelBuilder.Entity("NodexMeshApi.Models.SystemSettings", b =>
                {
                    ...
                    b.Property<bool>("EmailAdminAlertsEnabled")
                        .HasColumnType("boolean")
                        .HasColumnName("email_admin_alerts_enabled");
                    ...
                    b.Property<string>("EmailPasswordProtected")
                        .HasColumnType("text")
                        .HasColumnName("email_password_protected");
                    ...
                    b.Property<bool>("EmailUseSsl")
                        .HasColumnType("boolean")
                        .HasColumnName("email_use_ssl");

                    b.Property<bool>("EmailUserNotificationsEnabled")
                        .HasColumnType("boolean")
                        .HasColumnName("email_user_notifications_enabled");
