...
import {
  createCanvasItem,
} from '@/features/canvas/utils/createCanvasItem';
import { CanvasPoint, FrameDraft, SelectionBox } from '@/features/canvas/types';
