  ...
  return (
    <section
      ...
      style={{
        ...
        background: item.color ?? "var(--color-surface)",
        borderColor: "var(--color-border)",
        color: item.color ? (isLightColor(item.color) ? '#1e293b' : '#f8fafc') : "var(--color-text-primary)",
        ...
        '--block-background': item.color ?? 'var(--color-surface)',
