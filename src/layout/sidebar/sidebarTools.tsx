...
import { FileText, Code, PanelsTopLeft, Layers, Minus, GanttChart, Workflow, Pencil, Database } from 'lucide-react';
...
export const SIDEBAR_TOOLS: SidebarTool[] = [
  ...
  { id: 'divider', label: 'Divider', icon: <Minus size={TOOL_ICON_SIZE} /> },
  {
    ...
    label: 'Select',
    icon: (
      <svg width={TOOL_ICON_SIZE} height={TOOL_ICON_SIZE} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
