...
export const nodexMeshDemoProject: Project = {
  ...
  items: [
      ...
      columns: [
        {
          ...
          color: '#5a8a94',
          cards: [
            { id: '24763eb0-ffc8-40a1-bcb7-88f1110fed3b', text: 'Implement MindMapBlock', done: false },
            {
              id: '05d0d64e-b580-4f03-8222-936b5d51d5af',
              text: 'Make in timeline tasks show and dissappear when moving to the left or right',
              done: true,
            },
            { id: 'a5386ae7-f1c7-4367-a1a3-48b2e1968a31', text: 'Implement IconBlock', done: true },
            {
            ...
            { id: 'f2f1499d-7642-46fe-a808-9b1ead34b34f', text: 'Implement arrows flexibility', done: true },
            { id: '5b8b8932-7a57-4453-bacd-da9382792cf4', text: 'Increase the default item width', done: true },
            {
            ...
            { id: 'e92fb8bb-1d2d-4e0c-88ee-f5580539740d', text: 'Add changing colors in kanban columns', done: true },
            {
            ...
            { id: '1d5fee50-b5f2-47e2-bf22-25876ca24694', text: 'Add a new Divider item', done: true },
          ],
          width: 362,
        },
        {
          ...
          cards: [
            ...
            { id: '898e12c5-c658-4b57-af4d-f7913d676a0f', text: 'Implement horizontal layout for diagram', done: true },
            {
            ...
            { id: '5c060651-9414-4ec3-a477-5f24333eee1e', text: 'Fix task height in checklists', done: true },
            { id: '2d1d74b8-3413-4123-8f2b-f065c5d98a41', text: 'Implement DbDiagramBlock', done: true },
            {
              id: '1257e9fb-b146-4f88-9b61-b1ee95bbd40c',
              text: 'Implement manual cleaning projects trash',
              done: true,
            },
            { id: '98dc3def-2ac0-4a1b-9807-0f75f159bc6b', text: 'Update readme', done: true },
            { id: '95bcbf50-1113-42d1-bd51-d986295f9342', text: 'Add auto-fit to checklists', done: true },
            {
              id: '787f3f62-ccb4-40be-a1af-1c4ff66fe05f',
              text: 'Add vertical text alignment to item alignment options',
              done: true,
            },
            { id: '3fa338ea-1d10-4eef-a70e-2d0c952557fa', text: 'Adjust diagramblock', done: true },
            {
            ...
            { id: 'e5c07d5e-49cb-473b-8abd-0654ebe60c24', text: 'Fix data-scroll in timeline', done: true },
            { id: '78fd9b03-c7d3-4949-b29b-6245ab3e62ee', text: 'Implement moving columns in kanban', done: true },
            {
        ...
        },
        {
          ...
          color: '#02A0A0',
          cards: [
            { id: '54622807-1740-42a7-b802-a36601b0ec5e', text: 'Implement export/import projects', done: true },
            {
            ...
            { id: 'f4caf084-4c0a-4ce1-bf5e-57368b03e6e1', text: 'Implement mobile devices compability', done: true },
            { id: '7d309b19-2210-4c14-8929-0a1babb6c728', text: 'Plan database scheme', done: true },
            { id: '00709370-d4e7-4ca4-a575-983b28080c7b', text: 'Plan backend', done: true },
            {
            ...
            { id: '9031a94b-759e-4751-b5a2-c140612b5c00', text: 'Add the ability to rename a project', done: true },
            { id: '8cc3b091-bab6-4c7b-b48e-d9f5e9c83e09', text: 'Implement drawing on canvas', done: true },
            {
            ...
            { id: '3b05c9f6-528d-4ec8-94b9-e4f8313453c9', text: 'Fix document block error', done: true },
            {
    ...
    },
    {
      title: 'Future Plans',
      entries: [
        { id: '35cbf4b2-003a-471b-96b7-d2fb2352f457', text: 'Custom application color themes', done: true },
        {
        ...
        { id: 'aacd4a59-1a00-4ae9-af86-13736eb8d8b1', text: 'API in C# .NET 10', done: false },
        {
        ...
        { id: '8e2b5802-492d-45d1-aa42-04bf2c56aee0', text: 'Read-only project sharing', done: false },
      ],
    ...
    },
    {
      title: 'Done',
      entries: [
        { id: '33046914-9d76-4aed-b8a8-2fa1bead95e4', text: 'Lock items to prevent accidental movement', done: true },
        {
          id: '70e16731-72ce-4e83-bd94-bded3c1c2931',
          text: 'Assign tags to items and highlight items when a tag is selected',
          done: true,
        },
        { id: 'e1aa795d-554a-4806-870e-caadad0dfe3e', text: 'Labels on arrows', done: true },
        {
        ...
        { id: 'b79b53f8-86ce-4a9f-a429-9788b910b1c3', text: 'Divider', done: true },
        {
        ...
        { id: '733c355d-e017-45ce-ab5e-f895517b4491', text: 'DiagramBlock', done: true },
        {
        ...
        { id: '5a8db220-7d59-4d87-8a08-d0e6d38e63d1', text: 'Project management', done: true },
        {
        ...
        { id: '53bc6f6a-cbbc-4585-8a1c-b6f7f785c7ae', text: 'Drawing - drawing on canvas', done: true },
      ],
      color: '#ffffff',
      ...
      tasks: [
        {
          ...
          color: '#000000',
          checklist: [
            { id: 'b25a96fc-70af-4d9e-ab65-be673c1b2597', text: 'DocumentBlock is throwing error', done: true },
            { id: 'c44f5813-09a9-43e8-9192-46f2eef2a0e5', text: 'Add more fonts to app', done: true },
          ],
        },
        {
        ...
        },
        {
          ...
          color: '#000000',
          checklist: [
            { id: 'e1745144-6a91-40f4-ae30-fdfec2df5640', text: 'Timeline', done: true },
            { id: 'ef15ed6e-5bac-4ffc-9df0-4549210dfb9b', text: 'Kanban', done: true },
          ],
        },
        {
        ...
        },
        {
          ...
          color: '#000000',
          checklist: [
            { id: 'cebdb6c0-b33f-4ba1-9b55-6048fa27e578', text: 'IconBlock', done: true },
            { id: '007b7335-aca4-48f0-a1b6-6dbc7ad671da', text: 'MindmapBlock', done: false },
          ],
        },
        {
      ...
      columns: [
        {
          ...
          color: '#5a8a94',
          cards: [
            { id: '0877c088-83e5-4b7d-a13f-2884e468d25c', text: 'Change editing kanban columns to dialog', done: true },
            {
            ...
            { id: '7bc1cdad-3fd8-4a89-8da2-a5d138eb14c7', text: 'Implement arrow flexibility', done: true },
            {
            ...
            { id: 'b24e60ff-6768-4124-85ba-f5459cdb469c', text: 'Edit timeline tasks in a dialog', done: true },
            {
        ...
        },
        {
          ...
          cards: [
            ...
            { id: 'aa9a407b-4114-463f-acea-27aaa37b5168', text: 'Fix vertical alignment in NoteBlock', done: true },
            {
